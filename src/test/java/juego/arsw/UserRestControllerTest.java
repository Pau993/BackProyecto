...
void testAfterConnectionClosed() throws Exception {
    ...
    // Configurar el estado manualmente en lugar de llamar a afterConnectionEstablished
    String playerId = "123TEST"; // ID fijo para la prueba
    when(mockSession.getId()).thenReturn("session-id-123");
    when(mockSession.isOpen()).thenReturn(true);
    ...
    void testGeneratePlate() throws Exception {
        ...
        assertNotNull(plate);
        assertEquals(6, plate.length());
        
        // Los primeros 3 caracteres deben ser dígitos
        for (int i = 0; i < 3; i++) {
            assertTrue(Character.isDigit(plate.charAt(i)));
        }
        
        // Los últimos 3 caracteres deben ser letras mayúsculas
        for (int i = 3; i < 6; i++) {
            assertTrue(Character.isUpperCase(plate.charAt(i)));
        }
    }
    ...
    void testBroadcastingFunctions() throws Exception {
        ...
        java.lang.reflect.Method broadcastPositionsMethod = UserRestController.class.getDeclaredMethod("broadcastPlayerPositions");
    ...
    void testBroadcastPersonStatus() throws Exception {
        ...
        // Acceder al método privado
        java.lang.reflect.Method broadcastPersonStatusMethod = 
            UserRestController.class.getDeclaredMethod("broadcastPersonStatus", String.class, String.class);
    ...
    void testBroadcastPlayersCountToAdmins() throws Exception {
        ...
        // Acceder al método privado
        java.lang.reflect.Method broadcastCountMethod = 
            UserRestController.class.getDeclaredMethod("broadcastPlayersCountToAdmins");
    ...
    void testSendPlayersCountToAdmin() throws Exception {
        ...
        // Acceder al método privado
        java.lang.reflect.Method sendCountMethod = 
            UserRestController.class.getDeclaredMethod("sendPlayersCountToAdmin", WebSocketSession.class);
...
void testHandleTextMessage_ErrorHandling() throws Exception {
    ...
    // Verificar que sendMessage fue llamado al menos una vez (no especificamos el número exacto)
    verify(mockSession, atLeastOnce()).sendMessage(any(TextMessage.class));
}
    ...
    void testBroadcastAvailablePersons() throws Exception {
        ...
        java.lang.reflect.Method broadcastMethod = 
            UserRestController.class.getDeclaredMethod("broadcastAvailablePersons");
    ...
    void testHandlePersonUpdate_PlayerNotFound() throws Exception {
        ...
        // Acceder al método privado
        java.lang.reflect.Method handleUpdateMethod = 
            UserRestController.class.getDeclaredMethod("handlePersonUpdate", String.class);
